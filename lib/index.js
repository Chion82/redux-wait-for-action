...
var WAIT_FOR_ACTION = _Symbol('WAIT_FOR_ACTION');
var ERROR_ACTION = _Symbol('ERROR_ACTION');
var CALLBACK_ARGUMENT = _Symbol('CALLBACK_ARGUMENT');
var CALLBACK_ERROR_ARGUMENT = _Symbol('ERROR_CALLBACK_ARGUMENT');
